...
export const common = {
  ...
  TERRABRASILIS_API_HOST: get(process, 'env.TERRABRASILIS_API_HOST', 'http://200.131.224.150/businessapi/api/v1/'),
  TERRABRASILIS_BUSINESS_API_HOST: get(process, 'env.TERRABRASILIS_BUSINESS_API_HOST', 'http://200.131.224.150/businessapi/api/v1/')
}
